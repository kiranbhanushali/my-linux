...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  --, ((modMask, xK_m), spawn $ "pragha" ) --music
  , ((modMask, xK_q), kill )
 -- , ((modMask, xK_r), spawn $ "rofi-theme-selector" )
  --, ((modMask, xK_t), spawn $ "urxvt" )
  , ((modMask, xK_v), spawn $ "pavucontrol" ) -- audio control
  , ((modMask, xK_y), spawn $ "polybar-msg cmd toggle" ) --top bar toggle
  , ((modMask, xK_x), spawn $ "arcolinux-logout" )
  , ((modMask, xK_Escape), spawn $ "xkill" ) -- select window to kill 
  , ((modMask, xK_Return), spawn $ "konsole" )
  , ((modMask, xK_F11), spawn $ "rofi -show drun -fullscreen" )
  , ((modMask, xK_F12), spawn $ "rofi -show drun" )

  -- FUNCTION KEYS
 -- , ((0, xK_F12), spawn $ "xfce4-terminal --drop-down" ) -- drop down terminal
  ...
  , ((controlMask .|. mod1Mask , xK_a ), spawn $ "xfce4-appfinder") --application finder
  , ((controlMask .|. mod1Mask , xK_b ), spawn $ "thunar")
  , ((controlMask .|. mod1Mask , xK_c ), spawn $ "catfish") -- file search
 ...
 -- , ((controlMask .|. mod1Mask , xK_r ), spawn $ "rofi-theme-selector")
  ...
  , ((mod1Mask, xK_f), spawn $ "variety -f" ) -- variety for wallpaper mana
...
myKeysExtra:: [(String, X ())]
myKeysExtra =[
 --- brighness
         ("<F2>", spawn "kill -9 -1")   
         ,("M-g>", spawn  "amixer -q set Master toggle")
        ]
